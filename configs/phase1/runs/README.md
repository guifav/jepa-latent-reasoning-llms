...
## Runtime entrypoints
- validation / inspection: `scripts/phase1_runner.py`
- train-capable runner: `scripts/phase1_train.py`
- local environment: `.venv_phase1`
...
- canonical handoff to `scripts/eval_regex_semantics.py` as a saved report step for RegexEval runs;
